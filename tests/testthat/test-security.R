...
# security-audit.yml workflow supplies the credentials as repository secrets so
# the audit actually runs there (and drives the README badge); in every other
# context (local runs, the verify/full-check/rhub suites) it skips cleanly
# rather than failing.
#
