...
- **hrbrmstr/punycode** (Bob Rudis) — the R package whose `puny_*` /
  ...
  surface `punycoder` descends from before rebuilding it on `libidn2`
  with explicit UTS \#46 processing.
...
- **The Public Suffix List** and the volunteers at Mozilla and across
  ...
  source of truth for registrable domains. See
...
And thanks to the R Core Team and CRAN’s volunteers, whose standards
make the rest of this possible.
