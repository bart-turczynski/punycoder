...
- **[pslr](https://bart-turczynski.github.io/pslr/)** — Public Suffix List engine. Uses `punycoder` for host canonicalization before PSL matching. Reach for it when you need eTLD or registrable-domain queries.
- **[rurl](https://bart-turczynski.github.io/rurl/)** — Full URL parsing, normalization, cleaning, and joining toolkit. Builds on both `punycoder` and `pslr` to handle the complete URL processing pipeline.
