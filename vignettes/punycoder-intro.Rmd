...
# Returns: "https://xn--caf-dma.example.com/menu"

# Decode URLs back to Unicode
url_decode("https://xn--caf-dma.example.com/menu")
# Returns: "https://café.example.com/menu"
...
# Process the data...
# results <- lapply(ascii_urls, function(url) { 
...
The package uses a C++ backend with Rcpp for performance, and follows RFC 3492 standards for punycode implementation. Future versions will integrate with GNU libidn2 for complete IDNA2008 compliance. 
